...
export default function DomeGallery({
  ...
  // Slow continuous auto-rotation, paused whenever the pointer is over the
  // gallery, while dragging/inertia is active, or while an image is
  // opened/opening — otherwise it'd fight the user's own interaction.
  useEffect(() => {
    ...
    const step = (t: number) => {
      ...
      if (
        ...
        const nextY = wrapAngleSigned(rotationRef.current.y + AUTO_ROTATE_DEG_PER_SEC * dt);
